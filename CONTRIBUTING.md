...
1. Clone the repo:
   ...
   `git clone https://github.com/workfoxes/kayo.git`
...
https://godoc.org/github.com/workfoxes/kayo. If there are
...
1. Install the test dependencies:
   ...
   `go get -t -d github.com/workfoxes/kayo/...`

1. Run the tests:

   `go test github.com/workfoxes/kayo/...`
